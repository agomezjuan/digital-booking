    ...
    <section className='gallery' id='gallery'>
      <div className='container'>
        ...
        <p className='section-text'>
          Descubre el encanto de cada destino a través de los ojos de nuestros
          huéspedes y déjate inspirar para tu próxima aventura. ¡Bienvenido a un
          mundo de viajes y recuerdos fotográficos que te transportarán a
