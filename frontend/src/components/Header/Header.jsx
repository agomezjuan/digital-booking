    ...
    <div className="container">
      ...
      <nav className="navbar" data-navbar>
        ...
        <div className="navbar-top">
          ...
          <a href="#" className="logo">
            <img src="./src/assets/images/logo-blue.png" alt="Hospic logo"/>
          </a>
        ...
        <ul className="navbar-list">
          ...
          <li>
            <a href="#" className="navbar-link" data-nav-link>Sobre Nosotros</a>
          </li>

          <li>
            <a href="#destination" className="navbar-link" data-nav-link>Hospedaje</a>
          </li>
          ...
          <li>
            <a href="#gallery" className="navbar-link" data-nav-link>Galería</a>
          </li>

          <li>
            <a href="#contact" className="navbar-link" data-nav-link>Contáctenos</a>
          </li>
